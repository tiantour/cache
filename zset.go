...
func (z Zset) ZADD(key string, value ...interface{}) *redis.Resp {
	args := []interface{}{key}
...
func (z Zset) ZCOUNT(key, start, stop string) *redis.Resp {
	return operate("ZCOUNT", key, start, stop)
}

// ZINCRBY 为有序集 key 的成员 member 的 score 值加上增量 increment 。
func (z Zset) ZINCRBY(key string, value ...interface{}) *redis.Resp {
	args := []interface{}{key}
	args = append(args, value...)
...
func (z Zset) ZRANGE(key, start, stop string, value ...interface{}) *redis.Resp {
...
func (z Zset) ZRANGEBYSCORE(key, start, stop string, value ...interface{}) *redis.Resp {
	args := []interface{}{key, start, stop}
	args = append(args, value...)
...
func (z Zset) ZRANK(key, value string) *redis.Resp {
	return operate("ZRANK", key, value)
}

// ZREM 删除数据
func (z Zset) ZREM(key string, value ...interface{}) *redis.Resp {
	args := []interface{}{key}
	args = append(args, value...)
...
func (z Zset) ZREMRANGEBYRANK(key, start, stop string) *redis.Resp {
	return operate("ZREMRANGEBYRANK", key, start, stop)
}

// ZREMRANGEBYSCORE 移除有序集 key 中，所有 score 值介于 min 和 max 之间(包括等于 min 或 max )的成员。
func (z Zset) ZREMRANGEBYSCORE(key, start, stop string) *redis.Resp {
	return operate("ZREMRANGEBYSCORE", key, start, stop)
}

// ZREVRANGE 返回有序集 key 中，指定区间内的成员。其中成员的位置按 score 值递减(从大到小)来排列。
func (z Zset) ZREVRANGE(key, start, stop string, value ...interface{}) *redis.Resp {
	args := []interface{}{key, start, stop}
	args = append(args, value...)
...
func (z Zset) ZREVRANGEBYSCORE(key, start, stop string, value ...interface{}) *redis.Resp {
	args := []interface{}{key, start, stop}
	args = append(args, value...)
...
func (z Zset) ZREVRANK(key string, start, stop string, value ...interface{}) *redis.Resp {
	args := []interface{}{key, start, stop}
	args = append(args, value...)
...
func (z Zset) ZSCORE(key, value string) *redis.Resp {
	return operate("ZSCORE", key, value)
}

// ZUNIONSTORE 计算给定的一个或多个有序集的并集，其中给定 key 的数量必须以 numkeys 参数指定，并将该并集(结果集)储存到 destination 。
func (z Zset) ZUNIONSTORE(dest string, number int, key ...interface{}) *redis.Resp {
...
func (z Zset) ZINTERSTORE(dest string, number int, key ...interface{}) *redis.Resp {
	args := []interface{}{dest, number}
	args = append(args, key...)
...
// ZSCAN scan
func (z Zset) ZSCAN(key string, cursor int, pattern string, count int) *redis.Resp {
...
func (z Zset) ZRANGEBYLEX(key, start, stop string, value ...interface{}) *redis.Resp {
	args := []interface{}{key, start, stop}
	args = append(args, value...)
